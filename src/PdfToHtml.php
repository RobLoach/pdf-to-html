...
namespace Ahmaadkhader\PdfToHtml;
...
class PdfToHtml {
   ...
   *
   * @param \Ahmaadkhader\PdfToHtml\StyleAnalyzer|null $styleAnalyzer
   *   The style analyzer, or NULL for default.
   * @param \Ahmaadkhader\PdfToHtml\TableDetector|null $tableDetector
   *   The table detector, or NULL for default.
   * @param \Ahmaadkhader\PdfToHtml\LinkExtractor|null $linkExtractor
   *   The link extractor, or NULL for default.
   * @param \Ahmaadkhader\PdfToHtml\HtmlRenderer|null $htmlRenderer
   *   The HTML renderer, or NULL for default.
   */
  public function __construct(
    protected ?StyleAnalyzer $styleAnalyzer = NULL,
    protected ?TableDetector $tableDetector = NULL,
    ...
    $this->linkExtractor ??= new LinkExtractor($this->styleAnalyzer);
    $this->htmlRenderer ??= new HtmlRenderer($this->styleAnalyzer);
  }
